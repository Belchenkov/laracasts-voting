...
class CategoryFiltersTest extends TestCase
{
    ...
    public function test_selecting_a_category_filters_correctly(): void
    {
    ...
    public function test_the_category_query_string_filters_correctly(): void
    {
        $user = User::factory()->create();
    ...
    public function test_selecting_a_status_and_a_category_filters_correctly(): void
    {
        $user = User::factory()->create();
    ...
    public function test_the_category_query_string_filters_correctly_with_status_and_category(): void
    {
        $user = User::factory()->create();
